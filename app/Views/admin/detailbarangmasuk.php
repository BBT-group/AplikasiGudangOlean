                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="datetime" name="datetime" value=" <?= date("F j, Y, G:i:s", strtotime($header['waktu'])); ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="input2">supplier</label>
                                <input type="text" class="form-control" id="nama_supplier" name="nama_supplier" value="<?= $header['nama'] ?>" disabled>
                            </div>
                        </div>
                    </div>
                </div>
