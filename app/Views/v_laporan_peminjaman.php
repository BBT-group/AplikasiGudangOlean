                            ...
                            <form method="get" action="<?= base_url('/laporan_peminjaman') ?>">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6" style="text-align: end;">
                                        <a href="<?= base_url('/laporan_peminjaman/exportp?start_date=' . (isset($start_date) ? $start_date : '') . '&end_date=' . (isset($end_date) ? $end_date : '')) ?>" class="btn btn-success">Export to Excel</a>
                                        <a href="<?= base_url('/laporan_peminjaman/printp?start_date=' . (isset($start_date) ? $start_date : '') . '&end_date=' . (isset($end_date) ? $end_date : '')) ?>" class="btn btn-info" target="_blank">Print</a>
                                    </div>
                                </div>
                            </form>
                        </div>
