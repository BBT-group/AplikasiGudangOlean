                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form method="get" action="<?= base_url('/laporan_peminjaman') ?>">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <a href="<?= base_url('/laporan_peminjaman') ?>" class="btn btn-secondary mr-2">Reset</a>
                                        <button type="submit" class="btn btn-primary mr-2">Tampilkan</button>
                                    </div>
                                    <div class="col-md-6" style="text-align: end;">
                                        <a href="<?= base_url('/laporan_peminjaman/exportp?start_date=' . (isset($start_date) ? $start_date : '') . '&end_date=' . (isset($end_date) ? $end_date : '')) ?>" class="btn btn-success"> <i class="fas fa-file-excel"></i> Export to Excel</a>
                                        <a href="<?= base_url('/laporan_peminjaman/printp?start_date=' . (isset($start_date) ? $start_date : '') . '&end_date=' . (isset($end_date) ? $end_date : '')) ?>" class="btn btn-info" target="_blank"><i class="fas fa-print"></i> Print</a>
                                    </div>
                                </div>
                            </form>
                        </div>
